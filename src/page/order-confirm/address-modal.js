/*
* @Author: lenovo
* @Date:   2017-08-07 12:33:31
* @Last Modified by:   lenovo
* @Last Modified time: 2017-08-08 09:21:22
*/
...
var addressModal = {
    ...
    loadCities : function(provinceName){
    	var cities = _cities.getCities(provinceName) || [], 
    		$citySelected = this.$modalWrap.find('#receiver-city');
    		$citySelected.html(this.getSelectOption(cities));
    },
    //获取表单里收件人的信息，并做表单的验证
